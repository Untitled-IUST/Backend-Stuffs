    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('password', models.CharField(max_length=255, unique=True)),
                ('groups', models.ManyToManyField(related_name='barber_groups', to='auth.group')),
                ('user_permissions', models.ManyToManyField(related_name='barber_user_permissions', to='auth.permission')),
            ],
            options={
                'abstract': False,
            },
